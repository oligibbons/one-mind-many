/*
  # Game system tables and functionality
  ...
  1. New Tables
    ...
    - `characters`
      ...
      - `location` (jsonb, character position)
    ...
    - `character_inventory`
      ...
      - `item_data` (jsonb, item properties)
    ...
    - `game_actions`
      ...
      - `turn_number` (integer, turn when action was taken)
      - `created_at` (timestamp)
  ...
  2. Security
    ...
    - Add policies for creating actions and viewing logs

  3. Functions
    - `update_character_location` - Update character position
    - `add_character_item` - Add item to character inventory
    - `queue_player_action` - Queue a player action
    - `add_narrative_log` - Add narrative log entry
*/
