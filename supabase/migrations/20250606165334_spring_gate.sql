/*
  # Game System Tables and Functions

  1. New Tables
    - `games` - Core game instances with status and settings
    - `characters` - Player characters in games with location and stats
    - `character_inventory` - Items owned by characters
    - `game_actions` - Player actions queued for processing
    - `game_logs` - Narrative and system logs for games

  2. Security
    - Enable RLS on all new tables
    - Add policies for game participants to access their game data
    - Secure functions for game operations
