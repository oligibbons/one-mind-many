/*
  ...
  1. New Tables
    ...
    - `game_ink_states`: Stores Ink story states
    - `game_objectives`: Tracks objective completion
...
-- RLS Policies (with proper existence checks)
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Players can view game players'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Players can view characters in their games'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'character_inventory' 
    AND policyname = 'Players can view character inventory in their games'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'game_actions' 
    AND policyname = 'Players can view actions in their games'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'game_actions' 
    AND policyname = 'Players can create actions in their games'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Players can view logs in their games'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'game_ink_states' 
    AND policyname = 'Players can view ink states in their games'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'game_ink_states' 
    AND policyname = 'Players can update ink states in their games'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'game_ink_states' 
    AND policyname = 'Players can insert ink states in their games'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'game_objectives' 
    AND policyname = 'Players can view objectives in their games'
  ) THEN
